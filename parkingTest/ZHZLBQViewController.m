...
@interface ZHZLBQViewController ()

@end
static CGFloat h = 120;

@implementation ZHZLBQViewController
...
- (void)demo1 {
    ...
    DCPicScrollView  *picView = [DCPicScrollView picScrollViewWithFrame:CGRectMake(0, 100, self.view.frame.size.width, h * 2) WithImageUrls:UrlStringArray];
